...
% Fitting options
options = fitoptions('Method','NonlinearLeastSquares','StartPoint',x0,'Lower',0,'Upper',maxtime,'MaxIter',1000000,'TolFun',1.0000e-07,'Robust','on');
...
theoretical_times=gamrnd(1,tau,1,length(times_vector).*1E6);
...
% ECDF
subplot(1,2,1)
stairs(time',ECDF,'k','MarkerSize',10,'MarkerFaceColor','w','Linewidth',1.0)
set(gca,'XScale', 'log');
hold on
% TCDF 
plot(time,TCDF,'r','MarkerSize',10,'MarkerFaceColor','w','Linewidth',2.0)
